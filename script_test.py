...
from bot.core.components import EventManager, BaseEventSource
from bot.integrations.twitch.event_sources import TwitchEventSource


async def main():
    ev = EventManager()
    tw = ev.add_event_source(BaseEventSource)
    pass
