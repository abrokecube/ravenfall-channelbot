...
def token_set_ratio(s1, s2, force_ascii=..., full_process=...) -> int:
    ...

def partial_token_set_ratio(s1, s2, force_ascii=..., full_process=...) -> int:
    ...
...
def WRatio(s1, s2, force_ascii=..., full_process=...) -> int:
    """
...
def UWRatio(s1, s2, full_process=...) -> int:
    """
    Return a measure of the sequences' similarity between 0 and 100,
