...
default_processor = ...
_scorer_lowering = ...
def extractWithoutOrder(query, choices, processor=..., scorer=..., score_cutoff=...) -> Generator[tuple[Any, int | Any, Any] | tuple[Any, int | Any], Any, None]:
    """
...
def extract(query, choices, processor=..., scorer=..., limit=...):
    """
    Select the best match in a list or dictionary of choices.
...
def extractBests(query, choices, processor=..., scorer=..., score_cutoff=..., limit=...):
    """
...
def extractOne(query, choices, processor=..., scorer=..., score_cutoff=...) -> tuple[Any, int | Any, Any] | tuple[Any, int | Any]:
    """
...
def dedupe(contains_dupes, threshold=..., scorer=...) -> list[Any]:
    """
