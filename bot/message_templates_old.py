...
from .message_builders_old import (
    RavenBotMessageBuilder,
    RavenfallMessageBuilder,
    SenderBuilder,
    RecipientBuilder,
)
from .models_old import Sender, Recipient
...
class RavenBotTemplates:
    ...
    def auto_raid_status(
        sender: Sender, correlation_id: str | UUID | None = None
    ) -> RavenBotMessageBuilder:
    ...
    @staticmethod
    def auto_join_raid(
        sender: Sender, count: int = 2147483647, correlation_id: str | UUID | None = None
    ) -> RavenBotMessageBuilder:
        content = "on"
        if count != 2147483647:
            content = f"{count}"
    ...
    def sail(
        ...
        return RavenBotMessageBuilder(
            sender=sender, identifier="ferry_enter", correlation_id=correlation_id
        )

    @staticmethod
    def sail_to(
        sender: Sender, island_name: str, correlation_id: str | UUID | None = None
    ) -> RavenBotMessageBuilder:
        return RavenBotMessageBuilder(
            sender=sender,
